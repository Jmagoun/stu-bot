...
client.on('message', async message => { //reads every incoming message
  ...
  switch (command) {
    ...
    case "rules":
      ...
      break;
    case "regulars":
      let role = message.guild.roles.cache.find(r => r.name === 'Regular');
      ...
      break;
    case "superregulars":
      let roleS = message.guild.roles.cache.find(r => r.name === 'Super Regular');
    ...
    case "megasuperregulars":
      let roleM = message.guild.roles.cache.find(r => r.name === 'Mega Super Regular');
    ...
    case "ultramegasuperregulars":
      let roleU = message.guild.roles.cache.find(r => r.name === 'Ultra Mega Super Regular');
