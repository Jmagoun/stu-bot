...
client.on('message', async message => { //reads every incoming message
  ...
  switch (command) {
    ...
    case "rules":
      ...
      break;
    case "regulars":
      let role = message.guild.roles.fetch('639277446298075146');
      ...
      break;
    case "superregulars":
      let roleS = message.guild.roles.fetch('641831471157477387');
    ...
    case "megasuperregulars":
      let roleM = message.guild.roles.fetch('641831568700211212');
    ...
    case "ultramegasuperregulars":
      let roleU = message.guild.roles.fetch('664666451981893642');
